...
export default function NavBar() {
    ...
    return (
        ...
        <nav className="flex relative items-center justify-between px-3 md:px-6 py-2 w-full h-16 overflow-x-hidden bg-gradient-to-tr from-zinc-800/30 to-slate-800/30 z-50 border-b-2 border-gray-700/30">
            ...
            <Link className="py-1.5 active:scale-90 font-bold px-3 bg-black border rounded-md border-gray-700/50 lg:hover:border-gray-500/80 duration-200" href="/register">Sign Up</Link>
            <Link className="py-1.5 active:scale-90 font-bold px-3 bg-white text-black border rounded-md border-gray-700/50 lg:hover:border-gray-500/80 duration-200" href='/register?host=true'>Become a Host</Link>
            </div>
        </nav>  
        : null
    );
